...
ScanOCR(ratioX, ratioY, ratioW, ratioH, waitTime := 0, targetText := "", searchNumber := false) {
    ...
    if !WinExist(GameTitle) {
        MsgBox("Game window '" GameTitle "' is not running.")
        return -1
    }
...
num := ScanOCR(0.170, 0.455, 0.205-0.170, 0.700-0.455, , , true)
MsgBox(
    "Scanning Revuelto Stats Number..."
    "`nScanned: " num
    "`nExpected: 867299107749"
    "`nSimilarity: " Round(GetTextSimilarity(867299107749, num)) "%"
)

num := ScanOCR(0.177, 0.457, 0.205-0.177, 0.707-0.457, , , true)
MsgBox(
    "Scanning Revuelto Stats Number..."
    "`nScanned: " num
    "`nExpected: 867299107749"
